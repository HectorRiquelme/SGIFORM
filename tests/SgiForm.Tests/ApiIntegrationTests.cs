...
/// <summary>
/// Tests de integración completos para la API de SgiForm.
...
public class FlowEngineTests
{
    ...
    {
        var converter = new SgiForm.Infrastructure.Persistence.SnakeCaseEnumConverter<SgiForm.Domain.Enums.EstadoAsignacion>();

        // Verificar via reflexión que el converter transforma PascalCase a snake_case
        var method = typeof(SgiForm.Infrastructure.Persistence.SnakeCaseEnumConverter<SgiForm.Domain.Enums.EstadoAsignacion>)
        ...
        var result = converter.ConvertToProvider(SgiForm.Domain.Enums.EstadoAsignacion.EnEjecucion);
    ...
    {
        var converter = new SgiForm.Infrastructure.Persistence.SnakeCaseEnumConverter<SgiForm.Domain.Enums.TipoControl>();

        var result = converter.ConvertFromProvider("fotos_multiples");
        result.Should().Be(SgiForm.Domain.Enums.TipoControl.FotosMultiples);
    }
    ...
    public void SnakeCaseEnumConverter_TodosLosEstados()
    {
        ...
        foreach (var val in Enum.GetValues<SgiForm.Domain.Enums.EstadoAsignacion>())
        {
